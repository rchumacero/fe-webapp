export const COLLABORATOR_CONSTANTS = {
  TITLE: "crm.collaborator.title",
  ...
  VIEW_COLLABORATORS: "crm.collaborator.view",
  NO_PRODUCT_ID: "crm.collaborator.noProductId",
  GO_BACK: "common.back",
  COLUMNS: {
  ...
  ROUTES: {
    BACK: -1,
    COLLABORATOR: "/crm/commercial/collaborator",
    COLLABORATOR_NEW: "/crm/commercial/collaborator/new"
  },
